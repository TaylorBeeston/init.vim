...
wk.register({
    ...
    o = {
        ...
        r = {
            name = "+[R]eview/[Re]act",
            s = { "<cmd>Octo reviw start<CR>", "Start" },
            u = { "<cmd>Octo reviw submit<CR>", "S[u]bmit" },
            r = { "<cmd>Octo reviw resume<CR>", "Resume" },
            d = { "<cmd>Octo reviw discard<CR>", "Discard" },
            m = { "<cmd>Octo reviw comments<CR>", "Co[m]ments" },
            c = { "<cmd>Octo reviw commit<CR>", "Commit" },
            x = { "<cmd>Octo reviw close<CR>", "Close" },
            e = {
                name = "+R[e]act",
